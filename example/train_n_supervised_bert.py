...
if len(args.ckpt) == 0:
    args.ckpt = '{}_{}_{}_{}'.format(args.dataset, args.pretrain_path, args.pooler, datetime.now().astimezone().strftime("%Y-%m-%d_%H:%M:%S"))
...
for i in range(args.trials):
    ...
    logging.info('Micro F1: {}'.format(result['macro_f1']))
